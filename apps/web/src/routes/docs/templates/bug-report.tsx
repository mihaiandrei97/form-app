...
export const Route = createFileRoute("/docs/templates/bug-report")({
  head: () => ({
    meta: [
      {
      ...
      <main className="mx-auto max-w-5xl px-4 py-12">
        ...
        <section className="space-y-6">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            <code className="bg-muted rounded px-1.5 py-0.5 text-sm">Bug Reports</code> or{" "}
            <code className="bg-muted rounded px-1.5 py-0.5 text-sm">Issue Tracker</code>.
